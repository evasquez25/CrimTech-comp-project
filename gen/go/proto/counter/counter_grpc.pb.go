...
type CounterServiceClient interface {
	IncrementCounter(ctx context.Context, in *IncrementRequest, opts ...grpc.CallOption) (*CounterResponse, error)
}
...
func (c *counterServiceClient) IncrementCounter(ctx context.Context, in *IncrementRequest, opts ...grpc.CallOption) (*CounterResponse, error) {
...
type CounterServiceServer interface {
	IncrementCounter(context.Context, *IncrementRequest) (*CounterResponse, error)
...
func (UnimplementedCounterServiceServer) IncrementCounter(context.Context, *IncrementRequest) (*CounterResponse, error) {
